...
<form action="customers.php" method="POST">
  <div class="form-group">
    ...
    <input type="text" name="fn" id="fn" value="<?php echo $fn; ?>" required class="form-control" disabled>
  </div>
  <div class="form-group">
    <label for="ln">Lastname</label>
    <input type="text" name="ln" id="ln" value="<?php echo $ln; ?>" required class="form-control" disabled>
  </div>
  <div class="form-group">
    <label for="st">Street Address</label>
    <input type="text" name="ad" id="ad" value="<?php echo $st; ?>" class="form-control" disabled>
  </div>
  <div class="form-group">
